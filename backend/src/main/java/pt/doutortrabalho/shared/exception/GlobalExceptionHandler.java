...
import pt.doutortrabalho.auth.domain.exception.IdentityProviderException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleIdentityProviderException(IdentityProviderException ex) {
        log.error("Identity provider error: {}", ex.getMessage());
